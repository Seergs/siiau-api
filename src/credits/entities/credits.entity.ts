...
const mandatoryExample = new AreaCredits({
  required: '50',
  aquired: '50',
  left: '0',
});
const selectiveExample = new AreaCredits({
  required: '16',
  aquired: '23',
  left: '0',
});
const electiveExample = new AreaCredits({
  required: '16',
  aquired: '11',
  left: '5',
});
const commonBasicExample = new AreaCredits({
  required: '149',
  aquired: '149',
  left: '0',
});
const particularBasicExample = new AreaCredits({
  required: '144',
  aquired: '144',
  left: '0',
});
